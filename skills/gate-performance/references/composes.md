...
- ultraweb:physics — this gate's bundle audit only passes `domMax` (+25kb over domAnimation, 12.x-measured — unverified for 13 per STACK.md) when physics' drag/layout animation actually needs it.
