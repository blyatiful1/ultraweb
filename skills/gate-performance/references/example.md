...
build clean · first-load JS (wire, network log) `/` 132kB · `/game` 129kB (budget 140). `npm start`, then mobile Lighthouse.
...
CLS 0.00 on all; first-load JS (wire) `/devlog` 121kB · `/devlog/[slug]` 124kB · `/press` 118kB (budget 140).
