...
**Rejected:** Phase C full direction change (ultraweb:direction) — distinctiveness was 2/10, but the routes (`/practice/[area]`, `/attorneys`, `/insights/[slug]`) and the MDX content model were sound; burning it down would re-solve problems the site didn't have. Phase B carries it.
